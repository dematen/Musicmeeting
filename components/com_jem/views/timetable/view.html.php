 ...
 *
 */
class JEMViewTimetable extends JEMView
{
	/**
	 * Creates the Timetable View
	 *
	 *
	 */
	function display($tpl = null)
	{
		...
		$filter_order_Dir	= $app->getUserStateFromRequest('com_jem.timetable.filter_order_Dir', 'filter_order_Dir',	'', 'word');
